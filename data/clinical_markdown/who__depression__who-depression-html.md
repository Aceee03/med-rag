...
[WHO’s Comprehensive Mental Health Action Plan 2013–2030](https://www.who.int/publications/i/item/9789240031029) highlights the steps required to provide appropriate interventions for people with mental disorders including depression.
...
WHO has developed brief psychological intervention manuals for depression that may be delivered by lay therapists to individuals and groups. An example is the [Problem Management Plus (PM+) manual](https://www.who.int/publications/i/item/WHO-MSD-MER-18.5), which describes the use of behavioural activation, stress management, problem solving treatment and strengthening social support. Moreover, the [Group Interpersonal Therapy for Depression manual ](https://www.who.int/publications/i/item/WHO-MSD-MER-16.4)describes group treatment of depression. Finally, the [Thinking Healthy manual](https://www.who.int/publications/i/item/WHO-MSD-MER-15.1) covers the use of cognitive-behavioural therapy for perinatal depression.
